          ...
          <CardContent className="pt-8 space-y-6">
            {locale === 'zh' ? (
              <div className="space-y-6">
                <section>
                  <h2 className="text-xl font-semibold text-gray-800">1. 接受条款</h2>
                  <p className="text-gray-600">通过访问或使用 Mira 平台，您同意受这些服务条款的约束。如果您不同意这些条款，请勿使用我们的服务。</p>
                </section>
                <section>
                  <h2 className="text-xl font-semibold text-gray-800">2. 服务说明</h2>
                  <p className="text-gray-600">Mira 是一个基于 AI 的动画创作平台。我们保留根据业务需要修改、暂停或中断服务的权利，且无需承担责任。</p>
                </section>
                <section>
                  <h2 className="text-xl font-semibold text-gray-800">3. 用户账户</h2>
                  <p className="text-gray-600">您必须对您的账户凭据保密，并对您的账户下发生的所有活动负责。您必须年满 13 周岁才能使用本服务。</p>
                </section>
                <section>
                  <h2 className="text-xl font-semibold text-gray-800">4. 用户内容</h2>
                  <p className="text-gray-600">您保留对您上传至 Mira 的内容的所有权。但是，通过上传内容，您授予 Mira 一项全球性的、非排他性的、免版税的许可，允许我们仅为向您提供服务之目的使用、处理该内容。</p>
                </section>
                <section>
                  <h2 className="text-xl font-semibold text-gray-800">5. 禁止行为</h2>
                  <p className="text-gray-600">您不得利用我们的服务从事任何非法活动，包括但不限于上传侵权内容、恶意攻击系统、或利用 AI 生成有害内容。</p>
                </section>
                <section>
                  <h2 className="text-xl font-semibold text-gray-800">6. 免责声明</h2>
                  <p className="text-gray-600">服务按“原样”提供。Mira 不对 AI 生成内容的准确性、完整性或适用性作任何明示或暗示的保证。</p>
                </section>
                <section>
                  <h2 className="text-xl font-semibold text-gray-800">7. 责任限制</h2>
                  <p className="text-gray-600">在法律允许的最大范围内，Mira 对因使用本服务而产生的任何间接、偶然、特殊或惩罚性损害不承担责任。</p>
                </section>
              </div>
            ) : (
              <div className="space-y-6">

  ...
  return (
    <div className="bg-white rounded-xl shadow-[4px_4px_16px_rgba(0,0,0,0.1),-4px_-4px_16px_rgba(255,255,255,0.95)] p-6 space-y-6">
      ...
      <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
        ...
        <div>
          <h3 className="font-semibold text-gray-800">单词视频创作</h3>
          <p className="text-sm text-gray-500">配置你的单词学习视频</p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <Label className="text-gray-700 flex items-center gap-2">
          <span>添加单词</span>
          <span className="text-xs text-gray-400 font-normal">(按回车添加)</span>
        </Label>
      ...
      {/* 难度选择 */}
      <div className="space-y-3">
        <Label className="text-gray-700">难度级别</Label>
      ...
      {/* 重复次数 */}
      <div className="space-y-3">
        <Label className="text-gray-700">重复次数</Label>

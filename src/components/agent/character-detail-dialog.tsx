    ...
    return (
        <>
            <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
                <DialogContent showCloseButton={false} className="bg-gradient-to-br from-white to-green-50 border border-green-100 shadow-[8px_8px_24px_rgba(173,230,200,0.3),-8px_-8px_24px_rgba(255,255,255,0.9)] sm:max-w-[800px] max-h-[90vh] flex flex-col rounded-2xl p-0 overflow-hidden">
                    {/* Header */}
